"""Przeglądanie projektu: co jest w ledgerze i co leży w `out/`.
...
`out/ledger.json` i zawartość `out/` (katalog bierzemy z `Config.out_dir`, więc
ten moduł nie wie, gdzie stoi projekt).
"""
